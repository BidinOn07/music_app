...
import 'package:music_app/json/SongsJson.dart';
          ...
          children: [
            ...
            SingleChildScrollView(
              ...
              child: Padding(
                ...
                child: Row(
                  children: List.generate(songs.length - 3, (index) {
                    return Padding(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(
                              ...
                              PageTransition(
                                  alignment: Alignment.bottomCenter,
                                  child: AlbumPage(song: songs[index + 4]),
                                  type: PageTransitionType.scale));
                        },
                        child: Column(
                          children: [
